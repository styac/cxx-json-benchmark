...
#define RAPIDJSON_MALLOC(size) MemoryStatMalloc(size)
#endif
#ifndef RAPIDJSON_REALLOC
///! customization point for global \c realloc
#define RAPIDJSON_REALLOC(ptr, new_size) MemoryStatRealloc(ptr, new_size)
#endif
#ifndef RAPIDJSON_FREE
///! customization point for global \c free
#define RAPIDJSON_FREE(ptr) MemoryStatFree(ptr)
#endif
#endif
...
public:
#if TEST_INFO
    virtual const char* GetName() const override { return "RapidJSON AutoUTF (C++)"; }
